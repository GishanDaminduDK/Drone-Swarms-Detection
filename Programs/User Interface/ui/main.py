...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.drone_icon.setMinimumSize(QSize(50, 50))
        self.drone_icon.setMaximumSize(QSize(100, 100))
        self.drone_icon.setPixmap(QPixmap(u":/icon/icons8-radar-96.png"))
        ...
        self.main_title.setMinimumSize(QSize(100, 40))
        ...
        self.run_PB.setMaximumSize(QSize(300, 50))
        font1 = QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.scf_display.setText(QCoreApplication.translate("MainWindow", u"Loading SCF ...", None))
